...
def plotPreFitPostFit(region, category, ws_file, fitdiag_file, outdir, lumi, year, sb=False):
    ...
    channel = {
        ...
        "dimuon": category + "_dimuon",
        "gjets": category + "_photon",
        "signal": category + "_signal",
        "singleelectron": category + "_singleel",
        "dielectron": category + "_dielec",
    }
    ...
    if region in "signal":
        legend = TLegend(0.50, 0.60, 0.92, 0.92)
        ...
        legend = TLegend(0.5, 0.65, 0.90, 0.90)
